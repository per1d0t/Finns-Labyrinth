...
Shader "AcidTrip/AcidTrip" {
	...
	sampler2D _MainTex;
	float strength = 1.0f; //1.0f
	int sparkling = 0; //0
	float timer, speed = 1; //1
	float amplitude = 70, distortion = 0.25f; //70, 0.25f
	float sat;
	...
	{
		float3 satWeight = float3(0.299f, 0.587f, 0.114f); //(0.299f, 0.587f, 0.114f)
